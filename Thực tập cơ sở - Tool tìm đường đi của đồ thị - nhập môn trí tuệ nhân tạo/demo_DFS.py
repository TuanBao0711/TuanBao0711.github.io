...
class Ui_MainWindow_DFS(object):
	list_name = [] 
	num_node = 0
	...
	def retranslateUi(self, MainWindow):
	    ...
	    MainWindow.setWindowTitle(_translate("MainWindow", "Giải thuật DFS"))
	    self.Runbutton.setText(_translate("MainWindow", "RUN"))
	    self.label.setText(_translate("MainWindow", "Danh sách các nút"))
	    self.OKbutton.setText(_translate("MainWindow", "OK"))
	    self.label_title.setText(_translate("MainWindow", "Tool thuật toán DFS"))
